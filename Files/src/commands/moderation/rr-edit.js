...
module.exports = {
    ...
    description: 'Edits role reaction configurations.',
        ...
        try {
            ...
            if(!fetchedMessage) 
                ...
                if(msgModel) {
                    ...
                    message.lineReplyNoMention("There is no configuration for that message. Please use ?addreactions on a message to set up Role Reactions on that message.")
                }
            }
        }
        catch(err) {
